...
class Header extends React.Component {
  ...
  //   this.context.totalCartRef.current.innerText = cart.reduce((total, item) => total + item.qty, 0);
  // }
                  ...
                  <ul className="nav navbar-nav">
                    ...
                    <li>
                      <NavLink activeClassName="active" to="/cart">
                        ...
                        <span id="total-cart" ref={this.context.totalCartRef}>{this.context.totalCart}</span>
                        )
                      </NavLink>
                    </li>
                    <li>
